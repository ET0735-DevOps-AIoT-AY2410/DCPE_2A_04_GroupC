...
from detect_door_open import security, ir_sensor_security
    ...
    while True:
        if not shared_keypad_queue.empty():
            ...
            if keyvalue == 1:
                ...
                # Call the security function and pass the lcd_on_event
                security(lcd, lcd_on_event)
...
if __name__ == "__main__":
    ...
    # Start the IR sensor security thread
    ir_thread = Thread(target=ir_sensor_security, args=(shared_keypad_queue,))
    ir_thread.start()
